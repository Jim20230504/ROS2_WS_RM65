...
struct Setrealtimepush_
{
  ...
  explicit Setrealtimepush_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->plus_base_enable = false;
      this->plus_state_enable = false;
    }
  }
  ...
  _ip_type ip;
  using _aloha_state_enable_type =
    bool;
  _aloha_state_enable_type aloha_state_enable;
  using _arm_current_status_enable_type =
    bool;
  _arm_current_status_enable_type arm_current_status_enable;
  using _expand_state_enable_type =
    bool;
  _expand_state_enable_type expand_state_enable;
  using _hand_enable_type =
    bool;
  _hand_enable_type hand_enable;
  using _joint_speed_enable_type =
    bool;
  _joint_speed_enable_type joint_speed_enable;
  using _lift_state_enable_type =
    bool;
  _lift_state_enable_type lift_state_enable;
  using _plus_base_enable_type =
    bool;
  _plus_base_enable_type plus_base_enable;
  using _plus_state_enable_type =
    bool;
  _plus_state_enable_type plus_state_enable;
  ...
  Type & set__aloha_state_enable(
    const bool & _arg)
  {
    this->aloha_state_enable = _arg;
    return *this;
  }
  Type & set__arm_current_status_enable(
    const bool & _arg)
  {
    this->arm_current_status_enable = _arg;
    return *this;
  }
  Type & set__expand_state_enable(
    const bool & _arg)
  {
    this->expand_state_enable = _arg;
    return *this;
  }
  ...
  Type & set__joint_speed_enable(
    const bool & _arg)
  {
    this->joint_speed_enable = _arg;
    return *this;
  }
  Type & set__lift_state_enable(
    const bool & _arg)
  {
    this->lift_state_enable = _arg;
    return *this;
  }
  Type & set__plus_base_enable(
    const bool & _arg)
  {
    this->plus_base_enable = _arg;
    return *this;
  }
  Type & set__plus_state_enable(
    const bool & _arg)
  {
    this->plus_state_enable = _arg;
    return *this;
  }
  ...
  bool operator==(const Setrealtimepush_ & other) const
  {
    ...
    if (this->aloha_state_enable != other.aloha_state_enable) {
      return false;
    }
    if (this->arm_current_status_enable != other.arm_current_status_enable) {
      return false;
    }
    if (this->expand_state_enable != other.expand_state_enable) {
      return false;
    }
    if (this->hand_enable != other.hand_enable) {
      return false;
    }
    if (this->joint_speed_enable != other.joint_speed_enable) {
      return false;
    }
    if (this->lift_state_enable != other.lift_state_enable) {
      return false;
    }
    if (this->plus_base_enable != other.plus_base_enable) {
      return false;
    }
    if (this->plus_state_enable != other.plus_state_enable) {
      return false;
    }
    return true;
  }
