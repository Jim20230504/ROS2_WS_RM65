...
#include "rm_ros_interfaces/msg/detail/jointposcustom__rosidl_typesupport_fastrtps_c.h"
...
using _Jointposcustom__ros_msg_type = rm_ros_interfaces__msg__Jointposcustom;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Jointposcustom__ros_msg_type * ros_message = static_cast<const _Jointposcustom__ros_msg_type *>(untyped_ros_message);
  // Field name: joint
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Jointposcustom__ros_msg_type * ros_message = static_cast<_Jointposcustom__ros_msg_type *>(untyped_ros_message);
  // Field name: joint
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_rm_ros_interfaces__msg__Jointposcustom(
  const void * untyped_ros_message,
...
static uint32_t _Jointposcustom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Jointposcustom(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__Jointposcustom(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Jointposcustom;
    is_plain =
      (
...
static size_t _Jointposcustom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Jointposcustom(
...
static message_type_support_callbacks_t __callbacks_Jointposcustom = {
...
static rosidl_message_type_support_t _Jointposcustom__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Jointposcustom,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Jointposcustom)() {
  return &_Jointposcustom__type_support;
}
