...
: ${AMENT_CURRENT_PREFIX:="/home/jim/ros2_ws/install/tf2_sensor_msgs"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_sensor_msgs/environment/pythonpath.sh"
